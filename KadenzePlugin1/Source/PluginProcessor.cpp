...
//==============================================================================
const juce::String KadenzePlugin1AudioProcessor::getName() const
{
...
const juce::String KadenzePlugin1AudioProcessor::getProgramName (int index)
{
    return {};
}

void KadenzePlugin1AudioProcessor::changeProgramName (int index, const juce::String& newName)
{
}
...
void KadenzePlugin1AudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
    ...
    {
        mGainSmoothed = mGainSmoothed - 0.004f * (mGainSmoothed - mGainParameter->get());
...
juce::AudioProcessorEditor* KadenzePlugin1AudioProcessor::createEditor()
{
    return new KadenzePlugin1AudioProcessorEditor (*this);
}

//==============================================================================
void KadenzePlugin1AudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
